...
export default function PlayersPage({pagea}) {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            const response = fetch('http://localhost:20001/priorities')
    ...
    return (
        <>
            <h1 sx={{fontSize: "100px"}}>Priorities</h1>
                ...
                <Table sx={{minWidth: 650}} aria-label="simple table">
                    <TableHead>
                        <TableRow sx={{backgroundColor: "lightgray"}}>
                            ...
                            <TableCell component="th" align="center" sx={{ width: '50%' }}>Priority name</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {
